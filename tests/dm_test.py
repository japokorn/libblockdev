...
class DevMapperGetSubsystemFromName(DevMapperTestCase):
    ...
    def test_get_subsystem_from_name_lvm(self):
        ...
        subsystem = BlockDev.dm.get_subsystem_from_name("libbd_dm_tests-subsystem_lvm")
    ...
    def test_get_subsystem_from_name_crypt(self):
        ...
        subsystem = BlockDev.dm.get_subsystem_from_name("libbd_dm_tests-subsystem_crypt")
